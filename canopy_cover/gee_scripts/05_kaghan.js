// =============================================================
// STEP 5 of 6 — Kaghan / Hazara forest region
// Expected output: canopy_cover_05_kaghan.csv (~4500 rows)
// =============================================================
...
// --- Region ---
// Kaghan Valley + upper Hazara + AJK northern belt — expanded for full stratum coverage
...
Export.table.toDrive({
  collection: samples,
  description: 'canopy_cover_05_kaghan',
  folder: 'gee_exports',
  fileNamePrefix: 'canopy_cover_05_kaghan',
  fileFormat: 'CSV'
});
