// =============================================================
// STEP 6 of 6 — Non-forest samples (whole Pakistan)
// Expected output: canopy_cover_06_non_forest.csv (~5000 rows)
// =============================================================
...
// --- Non-forest mask ---
// unmask(0) fills masked pixels with 0 before inverting, so non-forest areas become 1
var nonForestStack = stack.updateMask(finalForestMask.unmask(0).not().selfMask());

// Oversample 5x then limit: ensures we reach PTS_NON_FOREST even after
// dropNulls discards pixels where the Landsat median has any null band.
...
Export.table.toDrive({
  collection: samples,
  description: 'canopy_cover_06_non_forest',
  folder: 'gee_exports',
  fileNamePrefix: 'canopy_cover_06_non_forest',
  fileFormat: 'CSV'
});
