// =============================================================
// STEP 2 of 6 — Temperate forest region
// Expected output: canopy_cover_02_temperate.csv (~4500 rows)
// =============================================================
...
// --- Region ---
// Murree hills, Abbottabad, Hazara — temperate oak/pine forests
var regionName = 'temperate';
var regionGeom = ee.Geometry.Rectangle([73.2, 33.8, 74.5, 35.0]);
...
Export.table.toDrive({
  collection: samples,
  description: 'canopy_cover_02_temperate',
  folder: 'gee_exports',
  fileNamePrefix: 'canopy_cover_02_temperate',
  fileFormat: 'CSV'
});
