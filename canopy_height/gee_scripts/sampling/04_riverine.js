// =============================================================
// CANOPY HEIGHT — STEP 4 of 6 — Riverine / montane forest region
// Expected output: canopy_height_04_riverine.csv (~4500 rows)
// Region: AJK belt — Muzaffarabad, Neelum valley
// =============================================================
...
// --- Region ---
// Expanded to cover full AJK belt for adequate forest density
...
Export.table.toDrive({
  collection:     samples,
  description:    'canopy_height_04_riverine',
  folder:         'gee_exports',
  fileNamePrefix: 'canopy_height_04_riverine',
  fileFormat:     'CSV'
});
