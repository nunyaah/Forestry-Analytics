// =============================================================
// CANOPY HEIGHT — STEP 2 of 6 — Temperate forest region
// Expected output: canopy_height_02_temperate.csv (~4500 rows)
// Region: Murree hills, Abbottabad, Hazara
// =============================================================
...
Export.table.toDrive({
  collection:     samples,
  description:    'canopy_height_02_temperate',
  folder:         'gee_exports',
  fileNamePrefix: 'canopy_height_02_temperate',
  fileFormat:     'CSV'
});
