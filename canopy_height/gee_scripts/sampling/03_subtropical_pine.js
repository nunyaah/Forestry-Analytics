// =============================================================
// CANOPY HEIGHT — STEP 3 of 6 — Subtropical pine forest region
// Expected output: canopy_height_03_subtropical_pine.csv (~4500 rows)
// Region: Murree, Abbottabad, Margalla Hills
// =============================================================
...
// --- Region ---
var regionName = 'subtropical_pine';
var regionGeom = ee.Geometry.Rectangle([72.8, 33.4, 73.9, 34.6]);
...
Export.table.toDrive({
  collection:     samples,
  description:    'canopy_height_03_subtropical_pine',
  folder:         'gee_exports',
  fileNamePrefix: 'canopy_height_03_subtropical_pine',
  fileFormat:     'CSV'
});
