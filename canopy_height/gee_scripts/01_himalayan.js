// =============================================================
// CANOPY HEIGHT — STEP 1 of 6 — Himalayan forest region
// Expected output: canopy_height_01_himalayan.csv (~4500 rows)
// Region: Swat, Chitral, Upper Dir — Pakistan's main himalayan conifers
// =============================================================
...
// Strata based on ETH canopy height:
//   1 = short    (0 – <5 m)
//   2 = moderate (5 – <15 m)
//   3 = tall     (≥15 m)
