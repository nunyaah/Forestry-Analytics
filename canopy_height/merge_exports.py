...
Usage:
    Place all 6 CSVs in canopy_height/data/raw_exports/
    then run:  python canopy_height/merge_exports.py
"""
...
OUTPUT_CSV = os.path.join(os.path.dirname(__file__), "data", "canopy_height_training.csv")

csv_files = sorted(glob.glob(os.path.join(RAW_DIR, "canopy_height_0*.csv")))
